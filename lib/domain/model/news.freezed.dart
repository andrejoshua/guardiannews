...
abstract class $NewsCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String headline, String section, String url, DateTime publicationDate});
}
...
class _$_News extends _News {
  const _$_News(this.headline, this.section, this.url, this.publicationDate)
      : super._();
  ...
  @override
  String toString() {
    return 'News(headline: $headline, section: $section, url: $url, publicationDate: $publicationDate)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, headline, section, url, publicationDate);
...
abstract class _News extends News {
  const factory _News(final String headline, final String section,
      final String url, final DateTime publicationDate) = _$_News;
